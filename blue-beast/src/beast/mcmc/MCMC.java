...
//
//        mc = new beast.markovchain.MarkovChain(prior, likelihood, schedule, criterion,
...
//    }
//
//    public final MarkovChainListener chainListener = new MarkovChainListener() {
//
...
//    public final boolean isAdapting = true;
//    public boolean stopping = false;
//    public boolean showOperatorAnalysis = true;
//    public String operatorAnalysisFileName = null;
//    public final dr.util.Timer timer = new dr.util.Timer();
//    public long currentState = 0;
//    //private int stepsPerReport = 1000;
//    public final NumberFormatter formatter = new NumberFormatter(8);
//
//    /**
//     * this markov chain does most of the work.
//     */
//    public dr.inference.markovchain.MarkovChain mc;
//
//    /**
//     * the options of this MCMC analysis
//     */
//    public MCMCOptions options;
//
//    public Logger[] loggers;
//    public OperatorSchedule schedule;
//
