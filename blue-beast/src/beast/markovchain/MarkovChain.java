...
//
//    public final OperatorSchedule schedule;
...
//    public double bestScore, currentScore, initialScore;
//    public long currentLength;
//
//    private boolean useCoercion = true;
//
//    public final int fullEvaluationCount;
//    public final int minOperatorCountForFullEvaluation;
//
...
//    }
//
//    public double evaluate(Likelihood likelihood, Prior prior) {
//
...
//     * @param logr
//     */
//    public void coerceAcceptanceProbability(CoercableMCMCOperator op, double logr) {
//
//        if (isCoercable(op)) {
...
//    }
//
//    public void fireBestModel(long state, Model bestModel) {
//
...
//    }
//
//    public void fireCurrentModel(long state, Model currentModel) {
//        for (MarkovChainListener listener : listeners) {
//            listener.currentState(state, currentModel);
//        }
//    }
//
//    public void fireFinished(long chainLength) {
//
//        for (MarkovChainListener listener : listeners) {
...
//    }
//
//    public final ArrayList<MarkovChainListener> listeners = new ArrayList<MarkovChainListener>();
//}
