/*
* HeidelbergConvergenceStatisticParser.java
*
...
public class HeidelbergConvergenceStatisticParser {
    ...
    public String getParserName() {
        return HEIDELBERG_CONVERGENCE_STATISTIC;
    }
...
//        return new HeidelbergConvergeStat(essLowerLimitBoundary);
    ...
    public String getParserDescription() {
        return
                "This element returns Heidelberg's convergence statistic";
    }

    public Class getReturnType() {
        return HeidelbergConvergeStat.class;
    }
